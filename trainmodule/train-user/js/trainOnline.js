layui.use('laypage', function(){
    ...
    function pageFenye(count,catId,titl){
        laypage.render({
                ...
                if(!first){
                        $.ajax({
                        url:"/seeyon/trainProgramCategory.do?method=userSelTrainPage&title="+titl+"&catId="+catId+"&page="+obj.curr+"&limit=10",
                        type:"get",
    ...
    //分页接口
            $.ajax({
                url:"/seeyon/trainProgram.do?method=userSelTrainPage&page=1&limit=10",
                        type:"get",
                        success:function(data){
                            var course =JSON.parse(data)
                            var code=course.code
    ...
    var app=new Vue({
        ...
        methods:{
            ...
            viewDetail:function(trid){
                window.location.href='/seeyon/trainmodule/train-user/trainDetail.html?train='+trid;
            },
            getFenlei:function(e){
                ...
                app.currentId=id;
                $.ajax({
                    url:"/seeyon/trainProgram.do?method=userSelTrainPage&catId="+id+"&page=1&limit=10",
                    type:"get",
            ...
            searchTitle:function(){
                ...
                app.currentId="";
                $.ajax({
                        url:"/seeyon/trainProgram.do?method=userSelTrainPage&title="+title+"&page=1&limit=10",
                        type:"get",
                        success:function(data){
                            var course =JSON.parse(data)
                            var code=course.code

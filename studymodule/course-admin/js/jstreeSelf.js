        ...
        $(function() {
            ...
            var urlstore="/seeyon/courseadmin.do?method=getCoursePage&catid=all&page=1&limit=10"
            var allSize=0;
            var cattid='all';
            ...
            function fenye(allSize,cattid){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj, first){
                        ...
                        var urlpage="/seeyon/courseadmin.do?method=getCoursePage&page="+obj.curr+"&limit="+obj.limit+'&catid='+cattid;
                        urlstore=urlpage;
            ...
            function pageMain(catid,page,limit){
                urlstore="/seeyon/courseadmin.do?method=getCoursePage&catid="+catid+"&page="+page+"&limit="+limit
                $.ajax({
                    url:urlstore,
                 //   url:"/seeyon/courseadmin.do?method=getCoursePage",
                    type:"post",

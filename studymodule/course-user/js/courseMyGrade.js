        ...
        methods: {
            getUrl: function (e, exam) {
                ...
                if (state == '正在答卷') {
                    ...
                    window.location.href='/seeyon/exammodule/exam-user/examDetail.html?exid=' + exam.exid
                } else if (state == '已答完卷') {
                    window.location.href="/seeyon/exammodule/exam-user/examFinish.html?state=true&examRecordid=" + id
                } else if (state == '未答卷') {
                    window.location.href='/seeyon/exammodule/exam-user/examDetail.html?exid=' + exam.exid
                }

...
if(examRecordid!=null&&examRecordid!=''&&examRecordid!=undefined){
    $.ajax({
                url:"/seeyon/userExamController.do?method=getSubmitExam",
                type:"post",
                ...
                success:function(data){
                    ...
                    if(code==0){
                        ...
                        if(m==false||state==true||state=='true'){
                            app.whereExit=true
                            app.exam=res.data;
...
var app=new Vue({
    ...
    data:{
        ...
        whereExit:false,
        view:true,
        exam:{'exid': '', "examRecordid":"", "title":"测试1",    "examTime":"60", "userScord":"", "examScord":"90", "userScord":"","question":[],

$(function(){
     //全局变量，存储试题勾选Id
     var examId=[];
     var urlStore="/seeyon/questionController.do?method=getPageResQuestion&catId=all"
          ...
          var i=0;
            table.render({
              ...
              /*  ,{field: 'qid', title: '#', width:'5%',  fixed: 'left',align:"center",templet: function(d){
                ...
                ,{field: 'labels', title: '试题标签', width:'12%',align:"center"}
                ,{field: 'createUser', title: '作者', width:'12%',align:"center"} 
                ,{field: 'catname', title: '试题分类', width: '11%',align:"center"}
                ,{field: 'qtypename', title: '题型', width: '10%',align:"center"}
                ,{field: 'score', title: '分数', width: '10%',align:"center"}
    ...
    $('#exam-tree').bind("activate_node.jstree", function (obj, e) {
        ...
        urlStore= '/seeyon/questionController.do?method=getPageResQuestion&catId='+id
        dataList(urlStore)
    ...
    //搜索
      ...
      dataList('/seeyon/questionController.do?method=getPageResQuestion&catId=all');
      //新增试题
    ...
    $("#delete-exam").click(function(e){
        ...
        $.ajax({
            url:"/seeyon/questionController.do?method=resQuestionById",
            type:"post",
            data:{"qid":strzq},
            success:function(data){
              alert("启用成功");
    ...
    $("#delete-list").click(function(e){
        window.location.href="./examAdmin.html"
    })
    //搜索 btn-search-question
    $("#btn-search-question").click(function(e){
        var key=$("#searchtitle").val();
        console.log(key)
        var ul="/seeyon/questionController.do?method=getPageResQuestion&catId=all&title="+key;
      dataList(ul)
    })
